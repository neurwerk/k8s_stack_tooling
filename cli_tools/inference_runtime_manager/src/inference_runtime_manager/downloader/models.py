...
class LicenseInfo(BaseModel):
    ...
    Args:
        ...
        commercial_use: Whether commercial use is permitted; None means unconfirmed.
        notice_required: Whether release notices must be retained.
        notes: Additional upstream licensing qualifications.
    """
...
class ModelVariant(BaseModel):
    ...
    Args:
        ...
        runtime_notes: Hardware, runtime, and companion-file guidance for this variant.
    """
...
class AvailableCatalog(BaseModel):
    ...
    Args:
        ...
        models: Selectable models grouped by task category.
    """
