...
from inference_runtime_manager.downloader.config import (
    Settings,
    huggingface_environment,
    validate_storage,
)
from inference_runtime_manager.downloader.errors import MediaDownloaderError
...
def _select_menu_option() -> str | None:
    ...
    selection: object = questionary.select(
        "Inference Runtime Manager — Model downloads",
