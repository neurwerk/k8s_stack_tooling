...
from local_ai_installer.downloader.errors import HuggingFaceCommandError
from local_ai_installer.downloader.huggingface import HuggingFaceClient
from local_ai_installer.downloader.models import ArtifactRequest
...
def test_verify_authenticated_rejects_missing_cli(monkeypatch) -> None:
    client = HuggingFaceClient({"PATH": ""})
    monkeypatch.setattr(
        "local_ai_installer.downloader.huggingface.shutil.which", lambda *args, **kwargs: None
    )
